...
const VehicleDispensesPage = ({ searchParams }: { searchParams: { tripNumber?: number, allocator: string } }) => {
    ...
    return (
        <div className="relative">
            ...
            {/* <div className="top-0 z-10 sticky hidden lg:hidden bg-background pb-2 bigScreen"> */}
            ...
            {/* <Accordion type="single" collapsible className="top-0 z-10 hidden lg:hidden bg-background py-2 smallScreen">
