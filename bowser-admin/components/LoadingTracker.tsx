                        ...
                        </div>
                        {
                            tripId && (
                                <div className={`${query.orderedBy ? "hidden" : ""} buttons flex flex-col gap-2 items-center w-full`}>
                                    ...
                                    {queryAction ? actionType === "loaded" && <Button className={`w-full ${actionType === "loaded" ? "bg-green-500 text-white hover:bg-green-200 hover:text-black" : ""}`} onClick={() => setActionType("loaded")}>Loaded</Button> : <Button className={`w-full ${actionType === "loaded" ? "bg-green-500 text-white hover:bg-green-200 hover:text-black" : ""}`} onClick={() => setActionType("loaded")}>Loaded</Button>}
                                </div>
                            )
                        }
