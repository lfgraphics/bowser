...
export default function VehiclesMainFilter({
  ...
  return (
    <div className="flex w-[320px] h-[186px] flex-row gap-2 border-2 dark:border-none dark:bg-black rounded-lg pr-2 overflow-clip">
      <div
      ...
      <div className="stats flex flex-col gap-5 justify-center items-center main">
