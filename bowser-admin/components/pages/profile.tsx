        ...
        if (name !== initialName || phoneNumber !== initialPhoneNumber) {
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    localStorage.setItem("adminUser", JSON.stringify({ ...user, name: name.trim(), phoneNumber: phoneNumber.replace(" ", "") }));
                    user && setUser({ ...user, name: name.trim(), phoneNumber: phoneNumber.replace(" ", "") });
                }
            } catch (error: any) {
                ...
                <CardContent>
                    <div className="flex flex-col space-y-4">
                        ...
                        {user?.department && <div className="flex justify-between gap-3">
                            <Label className='flex-[0.9]'>Goods Category</Label>
